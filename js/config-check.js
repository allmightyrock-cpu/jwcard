...
// 앱 대신 친절한 안내 화면을 띄워 설치 마법사(setup.html)로 유도한다.
  ...
  function show() {
    ...
    o.innerHTML =
      '<div style="max-width:420px;text-align:center">' +
        ...
        '<div style="font-size:14px;line-height:1.7;opacity:.9;margin-bottom:22px">Firebase 설정(<b>config.js</b>)이 아직 입력되지 않았거나 형식이 올바르지 않습니다.<br>아래 설치 마법사로 손쉽게 설정할 수 있어요.</div>' +
        '<a href="/setup.html" style="display:block;background:#FEE500;color:#191919;text-decoration:none;border-radius:12px;padding:14px;font-size:15px;font-weight:800;margin-bottom:10px">⚙️ 설치 마법사 열기</a>' +
